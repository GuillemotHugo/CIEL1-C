...
//Ecrire deux fonctions qui retourne une valeur entière permettant de savoir si l’entier passé en argument est multiple de deux et multiple de trois pour la seconde fonction. Utiliser ces deux fonctions dans un petit programme qui lit un nombre entier et qui précise s’il est pair, multiple de 3 et/ou multiple de 6.

// Réponse

int Multiple2_1(int nombre) {
    return (nombre % 2 == 0);
}

int Multiple3_1(int nombre) {
    return (nombre % 3 == 0);
}

int ch3tp2question1() {
    int nombre;
    printf("Entrez un nombre, je vais vous dire si il est multiple de 2,3 ou 6\n");
    scanf("%d", &nombre);
